...
We have estimated the asymmetry of alpha distributions and found out that the typical value of it is about 3\% and only at low $W$ ($< 1.36$~GeV) it can grow up to 10\%. So, this asymmetry is less than systematical error that we claim for high $W$ and comparable with it for low $W$($< 1.36$~GeV). 
